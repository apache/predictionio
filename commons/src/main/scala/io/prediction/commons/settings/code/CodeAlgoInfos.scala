  ...
  private val wipAlgoInfos = Map(
    ...
    "mahout-itembased" -> AlgoInfo(
      ...
      paramdefaults = Map(
        ...
        "maxPrefsPerUserInItemSimilarity" -> 1000,
      ...
      paramdescription = Map(
        ...
        "minPrefsPerUser" -> ("Min Num of Preferences per User", "Ignore users with less preferences than this."),
        "maxSimilaritiesPerItem" -> ("Max Num of Similarities per Item", "Maximum number of similarities considered per item."),
        "maxPrefsPerUserInItemSimilarity" -> ("Max Num of Preferences per User in Item Similarity", "Max number of preferences to consider per user in the item similarity computation phase, users with more preferences will be sampled down."),
