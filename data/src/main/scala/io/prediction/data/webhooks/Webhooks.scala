...
private[prediction] class EventConverter(val converter: WebhooksConverter) {
...
private[prediction] abstract class WebhooksConverter {
  ...
  def isReversable: Boolean = false
