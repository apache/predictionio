...
class RegressionAlgorithm2
    extends LAlgorithm[EmptyParams, TrainingData, Model, 
    Feature, Target2] {
  ...
  def predict(model: Model, feature: Feature): Target2 = {
    ...
    new Target2(date = feature.tomorrow, data = prediction)
  }
}
...
import _root_.io.prediction.Algorithm
//import _root_.io.prediction.EmptyParams
