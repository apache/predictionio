...
object Test {
  def main(args: Array[String]) {
    ...
    val ds = new FriendRecommendationDataSource(new FriendRecommendationDataSourceParams("data/item.txt", "data/user_key_word.txt", "data/user_action.txt"))
    ...
    val query1 = new FriendRecommendationQuery(1000022, 1774456)
    val query2 = new FriendRecommendationQuery(1000052, 1774684)
    val query3 = new FriendRecommendationQuery(1000054, 1774937)
