...
object MahoutSVDPlusPlus extends Controller {
  ...
  def updateSettings(app_id:String, engine_id:String, algo_id:String) = withUser { user => implicit request =>
    ...
    val algoSettingForm = Form(tuple(
      ...
      "app_id" -> number,
      "engine_id" -> number,
      "numFeatures" -> number, // TODO: verifying
      "learningRate" -> nonEmptyText,
      "preventOverfitting" -> nonEmptyText,
      "randomNoise" -> nonEmptyText,
      "numIterations" -> number,
      "learningRateDecay" -> nonEmptyText,
    ...
    algoSettingForm.bindFromRequest.fold(
      ...
      formData => {
        val (id, appId, engineId, 
          numFeatures, learningRate, preventOverfitting, randomNoise, numIterations, learningRateDecay,
