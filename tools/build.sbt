...
libraryDependencies ++= Seq(
  ...
  "org.apache.spark"  %% "spark-core"      % "1.0.0" exclude("org.spark-project.akka", "akka-actor_2.10") exclude("org.spark-project.akka", "akka-remote_2.10") exclude("org.spark-project.akka", "akka-slf4j_2.10"),
